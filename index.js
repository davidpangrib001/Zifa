...
`	
const buttojns = [
  {buttonId: '.command', buttonText: {displayText: '📖 𝗟𝗶𝘀𝘁 𝗠𝗲𝗻𝘂'}, type: 1},
  {buttonId: '.owner', buttonText: {displayText: '🙍‍♂️ 𝗢𝘄𝗻𝗲𝗿'}, type: 1},
  {buttonId: '.donasi', buttonText: {displayText: '💰 𝗗𝗼𝗻𝗮𝘁𝗶𝗼𝗻'}, type: 1}
]			
